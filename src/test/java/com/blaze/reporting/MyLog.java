...
/**
 * 
 * Log4j implementation It create a new file for every execution of suite
 * 
 * @author Zabiulla_Pro
 *
 */

public class MyLog extends Reporter implements FrameworkConstants {
